        ...
        {!statusAdmin ? (
          <div className="relative p-10 text-center space-y-8 flex-1 flex flex-col justify-center items-center">
            ...
            <form onSubmit={tanganiLoginAdmin} className="w-full max-w-xs space-y-4">
              <input type="password" placeholder="Passkey..." className="w-full bg-white/5 border border-white/10 rounded-2xl px-6 py-4 text-center outline-none focus:border-white text-white" value={inputKunciAdmin} onChange={e => setInputKunciAdmin(e.target.value)} />
              <button type="submit" className="w-full bg-white text-black py-4 rounded-2xl font-black uppercase text-xs">Unlock</button>
            </form>
          </div>
        ) : (
          <div className={`flex flex-1 overflow-hidden ${isAdminRoute ? 'flex-col-reverse' : 'flex-col md:flex-row'}`}>
            ...
            <div className={isAdminRoute ? "w-full bg-[#0a0a0a] border-t border-white/5 p-2 px-4 flex gap-2 overflow-x-auto custom-scrollbar z-50 shrink-0" : "w-full md:w-64 border-b md:border-b-0 md:border-r border-white/5 bg-black/40 p-6 flex md:flex-col gap-2 shrink-0"}>
              ...
              <button onClick={() => { setTabAdmin('portofolio'); resetForms(); }} className={`flex items-center justify-center shrink-0 ${isAdminRoute ? 'flex-col gap-1 min-w-[70px] p-2' : 'gap-3 px-4 py-3'} rounded-xl font-black transition-all ${tabAdmin === 'portofolio' ? 'bg-white text-black' : 'text-zinc-500 hover:text-white bg-white/5'}`}>
                <ImageIcon className={isAdminRoute ? 'w-5 h-5' : 'w-4 h-4'} />
                <span className={isAdminRoute ? 'text-[9px]' : 'text-xs'}>Karya</span>
              </button>

              <button onClick={() => { setTabAdmin('website'); resetForms(); }} className={`flex items-center justify-center shrink-0 ${isAdminRoute ? 'flex-col gap-1 min-w-[70px] p-2' : 'gap-3 px-4 py-3'} rounded-xl font-black transition-all ${tabAdmin === 'website' ? 'bg-white text-black' : 'text-zinc-500 hover:text-white bg-white/5'}`}>
                <ExternalLink className={isAdminRoute ? 'w-5 h-5' : 'w-4 h-4'} />
                <span className={isAdminRoute ? 'text-[9px]' : 'text-xs'}>Website</span>
              </button>

              <button onClick={() => { setTabAdmin('subkategori'); resetForms(); }} className={`flex items-center justify-center shrink-0 ${isAdminRoute ? 'flex-col gap-1 min-w-[70px] p-2' : 'gap-3 px-4 py-3'} rounded-xl font-black transition-all ${tabAdmin === 'subkategori' ? 'bg-white text-black' : 'text-zinc-500 hover:text-white bg-white/5'}`}>
                <Layout className={isAdminRoute ? 'w-5 h-5' : 'w-4 h-4'} />
                <span className={isAdminRoute ? 'text-[9px]' : 'text-xs'}>Album</span>
              </button>

              <button onClick={() => { setTabAdmin('skills'); resetForms(); }} className={`flex items-center justify-center shrink-0 ${isAdminRoute ? 'flex-col gap-1 min-w-[70px] p-2' : 'gap-3 px-4 py-3'} rounded-xl font-black transition-all ${tabAdmin === 'skills' ? 'bg-white text-black' : 'text-zinc-500 hover:text-white bg-white/5'}`}>
                <Sparkles className={isAdminRoute ? 'w-5 h-5' : 'w-4 h-4'} />
                <span className={isAdminRoute ? 'text-[9px]' : 'text-xs'}>Skills</span>
              </button>

              <button onClick={() => { setTabAdmin('journey'); resetForms(); }} className={`flex items-center justify-center shrink-0 ${isAdminRoute ? 'flex-col gap-1 min-w-[70px] p-2' : 'gap-3 px-4 py-3'} rounded-xl font-black transition-all ${tabAdmin === 'journey' ? 'bg-white text-black' : 'text-zinc-500 hover:text-white bg-white/5'}`}>
                <Play className={isAdminRoute ? 'w-5 h-5' : 'w-4 h-4'} />
                <span className={isAdminRoute ? 'text-[9px]' : 'text-xs'}>Journey</span>
              </button>

              <button onClick={() => { setTabAdmin('config'); resetForms(); }} className={`flex items-center justify-center shrink-0 ${isAdminRoute ? 'flex-col gap-1 min-w-[70px] p-2' : 'gap-3 px-4 py-3'} rounded-xl font-black transition-all ${tabAdmin === 'config' ? 'bg-white text-black' : 'text-zinc-500 hover:text-white bg-white/5'}`}>
                <Layout className={isAdminRoute ? 'w-5 h-5' : 'w-4 h-4'} />
                <span className={isAdminRoute ? 'text-[9px]' : 'text-xs'}>Tampilan</span>
              </button>

              <button onClick={() => { setTabAdmin('pricelist'); resetForms(); }} className={`flex items-center justify-center shrink-0 ${isAdminRoute ? 'flex-col gap-1 min-w-[70px] p-2' : 'gap-3 px-4 py-3'} rounded-xl font-black transition-all ${tabAdmin === 'pricelist' ? 'bg-white text-black' : 'text-zinc-500 hover:text-white bg-white/5'}`}>
                <AlertCircle className={isAdminRoute ? 'w-5 h-5' : 'w-4 h-4'} />
                <span className={isAdminRoute ? 'text-[9px]' : 'text-xs'}>Pricelist</span>
              </button>

              <button onClick={() => { setTabAdmin('artikel'); resetForms(); }} className={`flex items-center justify-center shrink-0 ${isAdminRoute ? 'flex-col gap-1 min-w-[70px] p-2' : 'gap-3 px-4 py-3'} rounded-xl font-black transition-all ${tabAdmin === 'artikel' ? 'bg-white text-black' : 'text-zinc-500 hover:text-white bg-white/5'}`}>
                <BookOpen className={isAdminRoute ? 'w-5 h-5' : 'w-4 h-4'} />
                <span className={isAdminRoute ? 'text-[9px]' : 'text-xs'}>Artikel</span>
              </button>

              <button onClick={() => { setTabAdmin('ig'); resetForms(); }} className={`flex items-center justify-center shrink-0 ${isAdminRoute ? 'flex-col gap-1 min-w-[70px] p-2' : 'gap-3 px-4 py-3'} rounded-xl font-black transition-all ${tabAdmin === 'ig' ? 'bg-white text-black' : 'text-zinc-500 hover:text-white bg-white/5'}`}>
              ...
              <div className={`flex ${isAdminRoute ? 'ml-auto gap-2 items-center' : 'md:mt-auto flex-col gap-2'}`}>
                ...
                }} className={`shrink-0 flex items-center justify-center rounded-xl font-black text-zinc-400 border border-white/10 transition-all hover:bg-white/5 ${isAdminRoute ? 'px-4 py-2 h-full' : 'w-full py-3 text-[10px]'}`}>
            ...
            <div className={`flex-1 overflow-y-auto custom-scrollbar bg-[#050505] pb-24 ${isAdminRoute ? 'p-4' : 'p-6 md:p-10'}`}>
                ...
                <div className="flex flex-col md:flex-row gap-8 md:gap-10">
                  <div className={`flex-1 space-y-5 ${isFormBuka ? 'block' : 'hidden md:block'}`}>
                    <form onSubmit={handleSimpanItem} className="space-y-4">
                      ...
                      <div className="space-y-2">
                        <div className="flex items-center gap-2">
                          ...
                          <div className="flex gap-1 ml-auto">
                            ...
                            <button type="button" onClick={() => setModeFoto('upload')} className={`px-3 py-1 rounded-lg text-[10px] font-bold transition-all ${modeFoto === 'upload' ? 'bg-white text-black' : 'text-zinc-600 hover:text-zinc-400'}`}>Upload</button>
                          </div>
                        </div>
                        {modeFoto === 'url' ? (
                          ...
                          <div className="space-y-2">
                            <label className="block w-full border-2 border-dashed border-zinc-700 hover:border-zinc-400 rounded-2xl px-5 py-4 text-center cursor-pointer transition-colors">
                            ...
                            {fotoUploading && (
                              <div className="space-y-1">
                                ...
                                <div className="h-1.5 bg-zinc-800 rounded-full"><div style={{ width: `${fotoProgress}%` }} className="h-full bg-white rounded-full transition-all" /></div>
                              </div>
                            )}
                        ...
                        <div className="space-y-2">
                          <div className="flex items-center gap-2">
                            <span className="text-[10px] text-zinc-500 uppercase tracking-widest font-semibold">Video</span>
                              ...
                              <button type="button" onClick={() => setModeVideo('upload')} className={`px-3 py-1 rounded-lg text-[10px] font-bold transition-all ${modeVideo === 'upload' ? 'bg-white text-black' : 'text-zinc-600 hover:text-zinc-400'}`}>Upload</button>
                            ...
                            <div className="space-y-2">
                              ...
                              {videoUploading && (
                                <div className="space-y-1">
                                  ...
                                  <div className="h-1.5 bg-zinc-800 rounded-full"><div style={{ width: `${videoProgress}%` }} className="h-full bg-white rounded-full transition-all" /></div>
                                </div>
                              )}
                      ...
                      <div className="rounded-2xl border border-white/10 bg-zinc-900/40 p-4 space-y-3">
                        <p className="text-[10px] uppercase tracking-widest text-zinc-500 font-semibold">Live Preview — tampilan publik</p>
                        <div className="aspect-video bg-zinc-800 overflow-hidden">
                          {itemBaru.image && <img src={itemBaru.image} alt="" className="w-full h-full object-cover" style={{ filter: 'grayscale(1) contrast(1.04)' }} />}
                        </div>
                        <div>
                          <p className="font-display uppercase text-lg leading-tight text-white">{itemBaru.title || 'Judul karya'}</p>
                          <p className="text-[11px] text-zinc-500 line-clamp-2 mt-1">{itemBaru.description || 'Deskripsi akan tampil di sini.'}</p>
                          <p className="text-[9px] uppercase tracking-widest text-zinc-600 mt-2">{itemBaru.category || 'kategori'}</p>
                        </div>
                      </div>
                      <button type="submit" disabled={fotoUploading || videoUploading} className="w-full bg-white text-black py-4 rounded-2xl font-black uppercase text-xs hover:bg-zinc-200 transition-all disabled:opacity-50"> {idEdit ? 'Simpan Perubahan' : 'Publikasikan'}</button>
                  ...
                  <div className={`flex-1 space-y-4 pr-2 custom-scrollbar ${isAdminRoute ? '' : 'max-h-[500px] overflow-y-auto'} ${!isFormBuka ? 'block' : 'hidden md:block'}`}>
                    <button onClick={() => { resetForms(); setIsFormBuka(true); }} className="w-full md:hidden mb-4 bg-zinc-900 border border-white/5 hover:border-white/20 text-white rounded-2xl py-4 font-bold text-[10px] uppercase tracking-widest transition-all shadow-[0_0_15px_rgba(0,0,0,0.5)] flex items-center justify-center gap-2">
                      <span className="text-white text-sm leading-none">+</span> Tambah Karya Baru
                    </button>

                    {/* FILTER KARYA ADMIN */}
                    <div className="flex gap-2 mb-4 overflow-x-auto custom-scrollbar pb-2">
                      {['all', 'photo', 'video', 'animation'].map(cat => (
                        <button key={cat} onClick={() => setFilterKategoriAdmin(cat)} className={`px-4 py-2 rounded-xl text-[10px] font-bold uppercase tracking-widest shrink-0 transition-all ${filterKategoriAdmin === cat ? 'bg-white text-black' : 'bg-zinc-900 text-zinc-500 hover:text-white border border-white/5'}`}>
                    ...
                    {daftarKarya.filter(item => filterKategoriAdmin === 'all' || item.category === filterKategoriAdmin).map(item => (
                      <div key={item.id} className={`flex items-center gap-4 p-3 bg-zinc-900/50 rounded-2xl border ${idEdit === item.id ? 'border-white' : 'border-white/5'}`}>
                        ...
                        <div className="flex gap-1">
                          ...
                          <button onClick={() => tanganiHapusKarya(item.id)} className="p-2 text-zinc-500 hover:text-zinc-300"><Trash2 className="w-3 h-3" /></button>
                        </div>
                      </div>
                    ))}
                ...
                <div className="flex flex-col md:flex-row gap-10">
                  <div className={`flex-1 space-y-6 ${isFormBuka ? 'block' : 'hidden md:block'}`}>
                    <form onSubmit={(e) => { e.preventDefault(); handleSimpanWebsite(webBaru, idEdit, resetForms); }} className="space-y-4">
                      ...
                      <div className="space-y-2">
                        <div className="flex items-center gap-2">
                          ...
                          <div className="flex gap-1 ml-auto">
                            ...
                            <button type="button" onClick={() => setModePreviewWeb('upload')} className={`px-3 py-1 rounded-lg text-[10px] font-bold transition-all ${modePreviewWeb === 'upload' ? 'bg-white text-black' : 'text-zinc-600 hover:text-zinc-400'}`}>Upload</button>
                          </div>
                        </div>
                        {modePreviewWeb === 'url' ? (
                      ...
                      <button type="submit" disabled={fotoUploading} className="w-full bg-white text-black py-4 rounded-2xl font-black uppercase text-xs hover:bg-zinc-200 transition-all disabled:opacity-50">{idEdit ? 'Simpan Perubahan' : 'Publikasikan Website'}</button>
                      <div className="flex gap-2 mt-2">
                  ...
                  <div className={`flex-1 space-y-3 pr-2 custom-scrollbar ${isAdminRoute ? '' : 'max-h-[500px] overflow-y-auto'} ${!isFormBuka ? 'block' : 'hidden md:block'}`}>
                    <button onClick={() => { resetForms(); setIsFormBuka(true); }} className="w-full md:hidden mb-4 bg-zinc-900 border border-white/5 hover:border-white/20 text-white rounded-2xl py-4 font-bold text-[10px] uppercase tracking-widest transition-all shadow-[0_0_15px_rgba(0,0,0,0.5)] flex items-center justify-center gap-2">
                      <span className="text-white text-sm leading-none">+</span> Tambah Web Baru
                    </button>
                    {daftarWebsite.map(site => (
                      <div key={site.id} className={`flex items-center gap-4 p-3 bg-zinc-900/50 rounded-2xl border ${idEdit === site.id ? 'border-white' : 'border-white/5'}`}>
                        ...
                        <div className="flex gap-1">
                          ...
                          <button onClick={() => tanganiHapusWebsite(site.id)} className="p-2 text-zinc-500 hover:text-zinc-300"><Trash2 className="w-3 h-3" /></button>
                        </div>
                      </div>
                    ))}
                ...
                <div className="flex flex-col md:flex-row gap-10">
                  <div className={`flex-1 space-y-6 ${isFormBuka ? 'block' : 'hidden md:block'}`}>
                    <form onSubmit={(e) => { e.preventDefault(); handleSimpanArtikel(artikelBaru, idEdit).then(resetForms); }} className="space-y-4">
                      ...
                      {/* LIVE PREVIEW — tampilan baca publik */}
                      <div className="rounded-2xl border border-white/10 bg-zinc-900/40 p-5 space-y-3">
                        <p className="text-[10px] uppercase tracking-widest text-zinc-500 font-semibold">Live Preview — halaman tulisan</p>
                        {artikelBaru.image && <img src={artikelBaru.image} alt="" className="w-full aspect-[16/9] object-cover" />}
                        <p className="font-display uppercase text-xl leading-tight text-white">{artikelBaru.title || 'Judul tulisan'}</p>
                        <p className="text-[9px] uppercase tracking-widest text-zinc-600">{artikelBaru.date || 'tanggal'}</p>
                        <div className="space-y-2 max-h-44 overflow-y-auto custom-scrollbar">
                          {(artikelBaru.content || 'Isi tulisan akan tampil di sini…').split(/\n{2,}/).filter(Boolean).slice(0, 4).map((par, i) => (
                            <p key={i} className="text-[11px] leading-relaxed text-zinc-400">{String(par).slice(0, 220)}{String(par).length > 220 ? '…' : ''}</p>
                          ))}
                        </div>
                      </div>
                      <button type="submit" className="w-full bg-white text-black py-4 rounded-2xl font-black uppercase text-xs hover:bg-zinc-200 transition-all">{idEdit ? 'Simpan Perubahan' : 'Publikasikan Artikel'}</button>
                      <div className="flex gap-2 mt-2">
                        {idEdit && <button onClick={resetForms} type="button" className="flex-1 text-zinc-500 text-[10px] uppercase py-2 hover:bg-white/5 rounded-xl transition-all">Batal Edit</button>}
                        <button onClick={() => setIsFormBuka(false)} type="button" className="flex-1 md:hidden text-zinc-500 text-[10px] uppercase py-2 hover:bg-white/5 rounded-xl transition-all">Tutup Form</button>
                      </div>
                  ...
                  <div className={`flex-1 space-y-3 pr-2 custom-scrollbar ${isAdminRoute ? '' : 'max-h-[500px] overflow-y-auto'} ${!isFormBuka ? 'block' : 'hidden md:block'}`}>
                    <button onClick={() => { resetForms(); setIsFormBuka(true); }} className="w-full md:hidden mb-4 bg-zinc-900 border border-white/5 hover:border-white/20 text-white rounded-2xl py-4 font-bold text-[10px] uppercase tracking-widest transition-all shadow-[0_0_15px_rgba(0,0,0,0.5)] flex items-center justify-center gap-2">
                      <span className="text-white text-sm leading-none">+</span> Tambah Artikel Baru
                    </button>
                    {daftarArtikel?.map(artikel => (
                      <div key={artikel.id} className={`flex items-center gap-4 p-3 bg-zinc-900/50 rounded-2xl border ${idEdit === artikel.id ? 'border-white' : 'border-white/5'}`}>
                        ...
                        <div className="flex gap-1">
                          ...
                          <button onClick={() => tanganiHapusArtikel(artikel.id)} className="p-2 text-zinc-500 hover:text-zinc-300"><Trash2 className="w-3 h-3" /></button>
                        </div>
                      </div>
                    ))}
                ...
                <div className="flex flex-col md:flex-row gap-10">
                  <div className={`flex-1 space-y-6 ${isFormBuka ? 'block' : 'hidden md:block'}`}>
                    <form onSubmit={handleSimpanSubKategori} className="space-y-4">
                      ...
                      <button type="submit" className="w-full bg-white text-black py-4 rounded-2xl font-black uppercase text-xs hover:bg-zinc-200 transition-all">{idEdit ? 'Simpan Perubahan' : 'Buat Album Baru'}</button>
                      <div className="flex gap-2 mt-2">
                        {idEdit && <button onClick={resetForms} type="button" className="flex-1 text-zinc-500 text-[10px] uppercase py-2 hover:bg-white/5 rounded-xl transition-all">Batal Edit</button>}
                        <button onClick={() => setIsFormBuka(false)} type="button" className="flex-1 md:hidden text-zinc-500 text-[10px] uppercase py-2 hover:bg-white/5 rounded-xl transition-all">Tutup Form</button>
                      </div>
                  ...
                  <div className={`flex-1 space-y-3 pr-2 custom-scrollbar ${isAdminRoute ? '' : 'max-h-[500px] overflow-y-auto'} ${!isFormBuka ? 'block' : 'hidden md:block'}`}>
                    <button onClick={() => { resetForms(); setIsFormBuka(true); }} className="w-full md:hidden mb-4 bg-zinc-900 border border-white/5 hover:border-white/20 text-white rounded-2xl py-4 font-bold text-[10px] uppercase tracking-widest transition-all shadow-[0_0_15px_rgba(0,0,0,0.5)] flex items-center justify-center gap-2">
                      <span className="text-white text-sm leading-none">+</span> Buat Album Baru
                    </button>
                    {daftarSubKategori.map(sub => (
                      <div key={sub.id} className={`flex items-center gap-4 p-3 bg-zinc-900/50 rounded-2xl border ${idEdit === sub.id ? 'border-white' : 'border-white/5'}`}>
                        {sub.cover_image ? (
                        ...
                        <div className="flex gap-1">
                          ...
                          <button onClick={() => tanganiHapusSubKategori(sub.id)} className="p-2 text-zinc-500 hover:text-zinc-300"><Trash2 className="w-3 h-3" /></button>
                        </div>
                      </div>
                    ))}
                ...
                <div className="flex flex-col md:flex-row gap-10">
                  <div className={`flex-1 space-y-6 ${isFormBuka ? 'block' : 'hidden md:block'}`}>
                    <form onSubmit={(e) => { e.preventDefault(); handleSimpanSkill(skillBaru, idEdit, resetForms); }} className="space-y-4">
                      ...
                      <button type="submit" className="w-full bg-white text-black py-4 rounded-2xl font-black uppercase text-xs hover:bg-zinc-200 transition-all"> {idEdit ? 'Simpan Skill' : 'Tambah Skill'}</button>
                      <div className="flex gap-2 mt-2">
                        {idEdit && <button onClick={resetForms} type="button" className="flex-1 text-zinc-500 text-[10px] uppercase py-2 hover:bg-white/5 rounded-xl transition-all">Batal Edit</button>}
                        <button onClick={() => setIsFormBuka(false)} type="button" className="flex-1 md:hidden text-zinc-500 text-[10px] uppercase py-2 hover:bg-white/5 rounded-xl transition-all">Tutup Form</button>
                      </div>
                  ...
                  <div className={`flex-1 space-y-3 pr-2 custom-scrollbar ${isAdminRoute ? '' : 'max-h-[500px] overflow-y-auto'} ${!isFormBuka ? 'block' : 'hidden md:block'}`}>
                    <button onClick={() => { resetForms(); setIsFormBuka(true); }} className="w-full md:hidden mb-4 bg-zinc-900 border border-white/5 hover:border-white/20 text-white rounded-2xl py-4 font-bold text-[10px] uppercase tracking-widest transition-all shadow-[0_0_15px_rgba(0,0,0,0.5)] flex items-center justify-center gap-2">
                      <span className="text-white text-sm leading-none">+</span> Tambah Skill Baru
                    </button>
                    {skills.map(item => (
                      <div key={item.id} className={`flex items-center justify-between p-4 bg-zinc-900/50 rounded-2xl border ${idEdit === item.id ? 'border-white' : 'border-white/5'}`}>
                        <div>
                        ...
                        <div className="flex gap-2">
                          ...
                          <button onClick={() => tanganiHapusSkill(item.id)} className="text-zinc-500 hover:text-zinc-300"><Trash2 className="w-3 h-3" /></button>
                        </div>
                      </div>
                    ))}
                  </div>
                ...
                <div className="flex flex-col md:flex-row gap-10">
                  <div className={`flex-1 space-y-6 ${isFormBuka ? 'block' : 'hidden md:block'}`}>
                    <form onSubmit={(e) => { e.preventDefault(); handleSimpanExperience(expBaru, idEdit, resetForms); }} className="space-y-4">
                      ...
                      <button type="submit" className="w-full bg-white text-black py-4 rounded-2xl font-black uppercase text-xs hover:bg-zinc-200 transition-all"> {idEdit ? 'Simpan Journey' : 'Tambah Journey'}</button>
                      <div className="flex gap-2 mt-2">
                        {idEdit && <button onClick={resetForms} type="button" className="flex-1 text-zinc-500 text-[10px] uppercase py-2 hover:bg-white/5 rounded-xl transition-all">Batal Edit</button>}
                        <button onClick={() => setIsFormBuka(false)} type="button" className="flex-1 md:hidden text-zinc-500 text-[10px] uppercase py-2 hover:bg-white/5 rounded-xl transition-all">Tutup Form</button>
                      </div>
                  ...
                  <div className={`flex-1 space-y-4 pr-2 custom-scrollbar ${isAdminRoute ? '' : 'max-h-[500px] overflow-y-auto'} ${!isFormBuka ? 'block' : 'hidden md:block'}`}>
                    <button onClick={() => { resetForms(); setIsFormBuka(true); }} className="w-full md:hidden mb-4 bg-zinc-900 border border-white/5 hover:border-white/20 text-white rounded-2xl py-4 font-bold text-[10px] uppercase tracking-widest transition-all shadow-[0_0_15px_rgba(0,0,0,0.5)] flex items-center justify-center gap-2">
                      <span className="text-white text-sm leading-none">+</span> Tambah Journey Baru
                    </button>
                    {experiences.map(item => (
                      <div key={item.id} className={`p-4 bg-zinc-900/50 rounded-2xl border ${idEdit === item.id ? 'border-white' : 'border-white/5'} hover:bg-zinc-900 transition-colors`}>
                        <div className="flex justify-between items-start mb-2">
                          ...
                          <div className="flex gap-2">
                            ...
                            <button onClick={() => tanganiHapusExperience(item.id)} className="text-zinc-500 hover:text-zinc-300"><Trash2 className="w-3 h-3" /></button>
                          </div>
                        </div>
              ...
              {tabAdmin === 'config' && (
                <div className="max-w-2xl mx-auto space-y-8 pb-10">
                  ...
                  <button onClick={handleSimpanConfig} className="w-full bg-white text-black py-5 rounded-[2rem] font-black uppercase text-xs hover:bg-zinc-200 transition-all shadow-xl">
                ...
                <div className="flex flex-col md:flex-row gap-10">
                  <div className={`flex-1 space-y-6 ${isFormBuka ? 'block' : 'hidden md:block'}`}>
                    <form onSubmit={(e) => { e.preventDefault(); handleSimpanPricelist(normalizePricelistPayload(pricelistBaru), idEdit).then(resetForms); }} className="space-y-4">
                      ...
                      <button type="submit" className="w-full bg-white text-black py-4 rounded-2xl font-black uppercase text-xs hover:bg-zinc-200 transition-all"> {idEdit ? 'Simpan Pricelist' : 'Tambah Pricelist'}</button>
                      <div className="flex gap-2 mt-2">
                        {idEdit && <button onClick={resetForms} type="button" className="flex-1 text-zinc-500 text-[10px] uppercase py-2 hover:bg-white/5 rounded-xl transition-all">Batal Edit</button>}
                        <button onClick={() => setIsFormBuka(false)} type="button" className="flex-1 md:hidden text-zinc-500 text-[10px] uppercase py-2 hover:bg-white/5 rounded-xl transition-all">Tutup Form</button>
                      </div>
                  ...
                  <div className={`flex-1 space-y-4 pr-2 custom-scrollbar ${isAdminRoute ? '' : 'max-h-[500px] overflow-y-auto'} ${!isFormBuka ? 'block' : 'hidden md:block'}`}>
                    <button onClick={() => { resetForms(); setIsFormBuka(true); }} className="w-full md:hidden mb-4 bg-zinc-900 border border-white/5 hover:border-white/20 text-white rounded-2xl py-4 font-bold text-[10px] uppercase tracking-widest transition-all shadow-[0_0_15px_rgba(0,0,0,0.5)] flex items-center justify-center gap-2">
                      <span className="text-white text-sm leading-none">+</span> Tambah Pricelist
                    </button>
                      ...
                      <div key={item.id} className={`p-4 bg-zinc-900/50 rounded-2xl border ${idEdit === item.id ? 'border-white' : 'border-white/5'} hover:bg-zinc-900 transition-colors`}>
                        <div className="flex justify-between items-start mb-2">
                          ...
                          <div className="flex gap-2">
                            ...
                            <button onClick={() => tanganiHapusPricelist(item.id)} className="text-zinc-500 hover:text-zinc-300"><Trash2 className="w-3 h-3" /></button>
                          </div>
                        </div>
